// Usando o beforeEach para garantir que a calculadora esteja limpa antes de cada teste
describe("Calculadora Simples", function() {

  // Limpa a tela e a variável currentInput antes de cada teste
  beforeEach(function() {
    clearDisplay(); // Limpa a tela e a variável antes de cada teste
  });
